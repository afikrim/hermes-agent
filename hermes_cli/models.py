...
_PROVIDER_MODELS: dict[str, list[str]] = {
    ...
    "google-antigravity": [
        # Gemini models fetched from Antigravity API (2026-06-18)
        "gemini-2.5-pro",
        "gemini-2.5-flash",
        ...
        "gemini-pro-agent",
        # Third-party models via Antigravity
        "claude-opus-4-6-thinking",
        "claude-sonnet-4-6",
        "gpt-oss-120b-medium",
        # With antigravity- prefix aliases (stripped by adapter)
...
CANONICAL_PROVIDERS: list[ProviderEntry] = [
    ...
    ProviderEntry("google-antigravity", "Google Antigravity (OAuth)", "Google Antigravity via OAuth (higher rate limits, sandbox endpoint)"),
...
PROVIDER_GROUPS: dict[str, tuple[str, str, list[str]]] = {
    ...
    "google":   ("Google Gemini",   "AI Studio API, Code Assist OAuth, or Antigravity OAuth", ["gemini", "google-gemini-cli", "google-antigravity"]),
